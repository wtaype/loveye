  ...
  <div class="lentes_container">
    ...
    <section class="lent_hero">
      ...
      <div class="lent_hero_visual">
        <img src="/loveye/v11/lentes.png" alt="Tipos de Lentes" class="lent_hero_img" loading="lazy">
      </div>
    </section>
    ...
    <section class="simulador_section">
      ...
      <div class="simulador_content">
        <div class="simulador_image_container">
          <img src="/loveye/v11/eyeCielo.png" alt="Simulador de Visión" class="simulador_image" id="simuladorImg">
        </div>
