  ...
  <div class="diagnostico_container">
    ...
    <section class="diag_hero">
      ...
      <div class="diag_hero_visual">
        <img src="/loveye/diagnostico.png" alt="Diagnóstico Ocular" class="diag_hero_img" loading="lazy">
      </div>
    </section>
...
`,u=()=>{console.log("✅ Diagnóstico completado"),i(".condicion_card",()=>{s(".condicion_card").each((a,e)=>{setTimeout(()=>{s(e).css({opacity:"0",transform:"translateY(30px)"}),setTimeout(()=>{s(e).css({transition:"all 0.6s cubic-bezier(0.4, 0, 0.2, 1)",opacity:"1",transform:"translateY(0)"})},50)},a*100)})}),i(".alerta_card",()=>{s(".alerta_card").each((a,e)=>{setTimeout(()=>{s(e).css({opacity:"0",transform:"scale(0.8)"}),setTimeout(()=>{s(e).css({transition:"all 0.5s cubic-bezier(0.4, 0, 0.2, 1)",opacity:"1",transform:"scale(1)"})},50)},a*120)})}),i(".examenes_timeline",()=>{s(".examen_item").each((a,e)=>{setTimeout(()=>{s(e).css({opacity:"0",transform:"translateX(-30px)"}),setTimeout(()=>{s(e).css({transition:"all 0.6s cubic-bezier(0.4, 0, 0.2, 1)",opacity:"1",transform:"translateX(0)"})},50)},a*200)})})},m=()=>{console.log("🧹 Diagnóstico limpiado")};export{m as cleanup,u as init,d as render};
