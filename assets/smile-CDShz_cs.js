import{j as t}from"./vendor-gzd0YkcT.js";import{g as n,d as f,s as d,b as l,N as c,c as h,S as p}from"./main-DYz9wJF0.js";import{c as v,d as u,T as m,s as g,b}from"./firebase-xYuwcABI.js";let e=n("wiSmile");const i="wiNotas",w=async()=>{const o=n(i),a=o?.fechaUpdate?l(m).get(o.fechaUpdate,"DD/MM/YYYY HH:mm"):"Sin notas";return`
   <div class="miweb">
   ...
   </div>`},y=async()=>{if(!n(i))try{const a=await v(u(f,"misnotas",e.usuario));if(a.exists()){const s=a.data();t(".nota-text").val(s.notas),d(i,s),t(".nota-fecha").html(`<i class="far fa-clock"></i> Actualizado: ${l(m).get(s.fechaUpdate,"DD/MM/YYYY HH:mm")}`),c("✅ Notas cargadas","success")}}catch(a){console.error(a),c("❌ Error al cargar","error")}t(".btn-save").click(async function(){const a=t(".nota-text").val().trim();if(!a)return c("⚠️ Escribe algo primero","warning");h(this,!0);try{const s=n(i);await g(u(f,"misnotas",e.usuario),{email:e.email,usuario:e.nombre,notas:a,fechaUpdate:b(),...!s?.fechaCreacion&&{fechaCreacion:b()}},{merge:!0});const r=Date.now();d(i,{email:e.email,usuario:e.nombre,notas:a,fechaUpdate:r,fechaCreacion:s?.fechaCreacion||r}),t(".nota-fecha").html(`<i class="far fa-clock"></i> Actualizado: ${l(m).get(r,"DD/MM/YYYY HH:mm")}`),c("✅ Guardado exitosamente!","success")}catch(s){console.error(s),c("❌ Error al guardar","error")}finally{h(this,!1)}}),t(".btn-delete").click(function(){confirm("¿Eliminar todas las notas?")&&(t(".nota-text").val(""),t(".nota-fecha").html('<i class="far fa-clock"></i> Nota creada: Sin notas'),c("🗑️ Notas eliminadas","info"))})},k=()=>{console.log("😊 Smile limpiado")};export{k as cleanup,y as init,w as render,e as smile};
