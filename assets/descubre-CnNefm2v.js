import{j as t}from"./vendor-gzd0YkcT.js";import{c as i,v as f}from"./wii-CaeySyXd.js";import{c as o,a as h}from"./main-BYtKKCJn.js";import"./main-EGFyYK60.js";import"./firebase-xYuwcABI.js";const y=()=>`
  <div class="descubre_container">
    ...
    <div class="descubre_hero">
      ...
      <h1 class="hero_title">Tu Centro Multimedia Completo con ${i}</h1>
    ...
    <div class="benefits_quick">
      <h2 class="section_title_center">
        <i class="fas fa-star"></i> ¿Por qué elegir ${i}?
      </h2>
    ...
    <div class="auth_cta_section">
      <div class="auth_cta_content">
        ...
        <p class="auth_note">
          <i class="fas fa-info-circle"></i> También puedes usar ${i} sin cuenta, todas las funciones están disponibles
        </p>
      </div>
    </div>
    ...
    <div class="comparison_section">
      <h2 class="section_title_center">
        <i class="fas fa-balance-scale"></i> ${i} vs Reproductores Tradicionales
      </h2>
    ...
    <div class="cta_final">
      <div class="cta_content">
        ...
        <p>Únete a <strong>+2,500 usuarios</strong> que ya usan ${i} diariamente</p>
    ...
    <div class="modalBody" style="background:var(--wb);max-width:800px">
      ...
      <div style="padding:3vh 2vw;font-family:var(--ff_P)">
        <h2 style="color:var(--tx);margin-bottom:2vh;text-align:center">
          <i class="fas fa-video" style="color:var(--mco)"></i> Demo de ${i}
        </h2>
...
`,x=()=>{t("[data-modal]").on("click",function(){const a=t(this).data("modal");o("modalRegister"),o("modalLogin"),h(a)}),t(".modalX").on("click",function(){t(this).closest(".wiModal").attr("id",(a,s)=>(o(s),s))});const c=()=>{t(".stat_number").each(function(){const a=t(this),s=parseInt(a.data("count")),n=2e3,d=60,v=s/d;let e=0;const u=setInterval(()=>{e+=v,e>=s?(a.text(s.toLocaleString()),clearInterval(u)):a.text(Math.floor(e).toLocaleString())},n/d)})},l=new IntersectionObserver(a=>{a.forEach(s=>{s.isIntersecting&&(c(),l.disconnect())})},{threshold:.3}),r=document.querySelector(".social_proof");r&&l.observe(r),console.log(`✅ Descubre ${i} ${f} cargado - Marketing multimedia activado`)},w=()=>{t("[data-modal], .modalX").off(),console.log("🧹 Descubre limpiado")};export{w as cleanup,x as init,y as render};
