import{j as i}from"./vendor-gzd0YkcT.js";import{c as t}from"./wii-CaeySyXd.js";import{a as f,c as p}from"./main-DxqYlT4S.js";import"./main-BRs8UjG_.js";import"./firebase-xYuwcABI.js";const g=()=>`
  <div class="inicio_container">
    ...
    <section class="benefits">
      <h2 class="section_title">
        <i class="fas fa-star"></i> ¿Por qué elegir ${t}?
      </h2>
    ...
    <section class="cta">
      <div class="cta_content">
        ...
        <p>Únete a <strong>+2,500 usuarios</strong> que ya usan ${t} diariamente</p>
    ...
    <div class="modalBody" style="background:var(--wb);max-width:800px">
      ...
      <div style="padding:3vh 2vw;font-family:var(--ff_P)">
        <h2 style="color:var(--tx);margin-bottom:2vh;text-align:center">
          <i class="fas fa-video" style="color:var(--mco)"></i> Demo de ${t}
        </h2>
...
`,y=()=>{i("#btnDemo").on("click",()=>{f("modalDemo")}),i(".modalX").on("click",function(){p("modalDemo")});const n=()=>{i(".stat_number").each(function(){const s=i(this),a=parseInt(s.data("count")),r=2e3,d=60,l=a/d;let e=0;const v=setInterval(()=>{e+=l,e>=a?(s.text(a.toLocaleString()),clearInterval(v)):s.text(Math.floor(e).toLocaleString())},r/d)})},c=new IntersectionObserver(s=>{s.forEach(a=>{a.isIntersecting&&(n(),c.disconnect())})},{threshold:.3}),o=document.querySelector(".stats_section");o&&c.observe(o),console.log("✅ Inicio completado")},x=()=>{i("#btnDemo, .modalX").off(),console.log("🧹 Inicio limpiado")};export{x as cleanup,y as init,g as render};
